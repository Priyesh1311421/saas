    ...
    <section>
      <Element name="pricing">
        <div className="container">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:border-32 max-md:pt-16 ">
            <h3 className="h3 max-lg:h4  max-md:h5 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm ">
            ...
            {plans.map((plan, index) => (
              ...
              <div key={plan.id} className="pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%-2px)] ">
                ...
                <div className={clsx('relative flex flex-col items-center', index === 1 ?'pt-24':'pt-12')}>
                  <div className={clsx('small-2 rounded-20 relative z-2 mx-auto mb-6 border-2 px-4 p-1.5 uppercase ', index === 1 ? 'border-p3 text-p3' : 'border-p1 text-p1')}>
                    {plan.title}
                  </div>
                  ...
                  <div className="relative z-2 flex items-center justify-center"> 
                    <div className={clsx('h-num flex items-start',index ===1 ? 'text-p3':'text-p4')}>
                      ₹<CountUp 
                          ...
                          end={!monthly ? plan.priceYearly:plan.priceMonthly}
                          duration={0.4}
                          useEasing={false}
                          preserveValue
                        />
                  ...
                  {plan.features.map((feature) =>(
                    <li key={feature} className="relative flex items-center gap-5 ">
                      <img
                        ...
                        alt="check"
                        className="aize-10 object-contain"
                      />
                      <p className="flex-1">
                        {feature}
                      </p>
